...
const FeatureBox = ({ icon, title, description }: FeatureBoxProps) => {
  return (
    <div className="flex items-start gap-4 group hover-scale mouse-tracking-border p-2 rounded">
...
const StatCard = ({ icon, title, value }: StatCardProps) => {
  return (
    <Card className="border-none shadow-lg hover-scale overflow-hidden bg-slate-900/40 border-slate-700/30 cyberpunk-card mouse-tracking-border">
