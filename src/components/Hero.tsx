...
const Hero = () => {
  return <div className="relative min-h-screen flex items-center overflow-hidden bg-black">
      {/* Background effects */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/apply">
                <Button size="lg" className="futuristic-button rounded-full bg-blue-950 hover:bg-blue-1000">
          ...
          <div className="hidden md:grid md:grid-cols-2 gap-6">
            <FeatureCard icon={<Code />} title="Coding" description="Learn programming languages and build real-world projects" className="animate-float mouse-tracking-border" delay="0s" />
            <FeatureCard icon={<Lightbulb />} title="Innovation" description="Develop creative solutions to everyday problems" className="animate-float mouse-tracking-border" delay="0.5s" />
            <FeatureCard icon={<Share2 />} title="Collaboration" description="Work together on tech projects and competitions" className="animate-float mouse-tracking-border" delay="1s" />
            <FeatureCard icon={<Rocket />} title="Workshops" description="Participate in hands-on tech learning sessions" className="animate-float mouse-tracking-border" delay="1.5s" />
          </div>
        </div>
      </div>
...
const FeatureCard = ({
  ...
  return <div className={`cyberpunk-card p-6 rounded-xl hover:bg-slate-800/40 transition-all duration-300 ${className}`} style={{
