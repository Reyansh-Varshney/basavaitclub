...
const Hero = () => {
  return (
    <div className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-violet-600 to-blue-600">
      {/* Background effects */}
      <div className="absolute inset-0">
        ...
        <div className="absolute -top-48 -right-48 w-96 h-96 bg-yellow-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
      </div>
      
      <div className="container mx-auto px-4 py-32 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="inline-block glass-card px-4 py-2 rounded-full text-sm font-medium text-white">
              Basava International School
            </div>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight text-white">
              Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-200 to-blue-200">Technexus</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/about">
                <Button size="lg" variant="outline" className="rounded-full text-white border-2 border-white hover:bg-white/10">
                  Learn More
                </Button>
              </Link>
            </div>
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="w-full">
          <path fill="#ffffff" fillOpacity="1" d="M0,224L48,224C96,224,192,224,288,208C384,192,480,160,576,154.7C672,149,768,171,864,176C960,181,1056,171,1152,149.3C1248,128,1344,96,1392,80L1440,64L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
        </svg>
      </div>
    </div>
  );
